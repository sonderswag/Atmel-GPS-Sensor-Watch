...
bool RFM_initialize(uint8_t freqBand, uint8_t nodeID, uint8_t networkID, char slaveSelectPin)
{
...
void RFM_select(char slaveSelectPin) 
{
	...
	digitalWrite(slaveSelectPin, 0); // turning on the chip select 
